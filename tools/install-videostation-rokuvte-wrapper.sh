...
mkdir -p "$BACKUP_DIR"
for name in rokuvte.cgi rokuvte.py VideoStation.api; do
...
chown VideoStation:system "$TARGET_DIR/rokuvte.cgi" "$TARGET_DIR/rokuvte.py"
...
echo "Installed:"
ls -l "$TARGET_DIR/rokuvte.cgi" "$TARGET_DIR/rokuvte.py"
